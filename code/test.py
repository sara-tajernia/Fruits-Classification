...
"""
    We train the program to recognize diffrent fruits so its time
    to test our program!!!
"""
number_of_train = 1962
number_of_test = 662
number_of_epochs = 10
batch_size = 10
batch_num = 196
...
for train_data in train_set[:number_of_train]:
    ...
    if predicted_number == real_number:
        counter += 1
print('Accuracy of train:', counter / number_of_train)


# find the accuracy of test
counter2 = 0
for test_data in test_set:
    ...
    if predicted_number == real_number:
        counter2 += 1
print('Accuracy of test:', counter2 / number_of_test)
